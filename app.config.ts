...
const rawBundleId = "com.app.cestanacionalmobile";
const bundleId =
  rawBundleId
...
const env = {
  ...
  appName: "Cesta Nacional Mobile",
  appSlug: "cesta-nacional-mobile",
  // S3 URL of the app logo - set this to the URL returned by generate_image when creating custom logo
  // Leave empty to use the default icon from assets/images/icon.png
  logoUrl: "/manus-storage/cesta-nacional-icon_318ca060.png",
